...
urlpatterns = [
    ...
    path('api/watchlist', views.WatchlistAuctionAPI.as_view(), name='api-watchlistAuction'),
    path('api/watchlist/<str:listing_id>/add', views.WatchlistAddAuctionAPI.as_view(), name='api-watchlistAddAuction'),
